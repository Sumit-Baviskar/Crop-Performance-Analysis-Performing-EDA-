...
**Correlation Analysis :** Create a correlation matrix to understand how numerical variables are related to each other. This will help in detecting multicollinearity or variables that could be useful for predictive models.
